        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <form action="register_db.php" class="card shadow p-4" method="post" enctype="multipart/form-data">
                    <h1 class="text-center mb-5">สมัครเป็นร้านอาหาร</h1>

                    <label for="" class="form-lable">ชื่อร้านอาหาร</label>
                    <input type="text" class="form-control mb-4" name="res_name" required>
                    ...
                    <select name="res_type" class="form-select mb-3" type="text">
